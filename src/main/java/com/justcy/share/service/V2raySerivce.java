 ...
 * 3. 前台页面展示信息
 */
public interface V2raySerivce {
	/**
	 * 1. 爬取 SS 并入库
	 * 2. SS 信息入库
	 */
	void crawlerAndSave(V2rayCrawlerService service);

	/**
	 * 3. 查询 SS 信息
	 */
	List<V2rayEntity> findAll(Pageable pageable);

	/**
	 * 随机查询一条可用 ss 信息
	 */
	V2rayDetailsEntity findFirstByRandom();

	/**
	 * 3. 生成 SSR 连接
	 */
	String toVmessLink(List<V2rayEntity> entities, boolean valid);
